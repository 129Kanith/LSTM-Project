...
print("Generating dataset with structured continuous time-blocks...")
...
df.to_csv(r"K:\LSTM\data\offline_dataset.csv", index=False)
print(f"Dataset generated successfully with {len(df)} records in sequential time-blocks: offline_dataset.csv")